  ...
  const REGIONS = [
    {
      ...
      label: "익산",
      route: "익산 왕궁 농경지 측정 → 전주 통합 관제",
      center: [35.95742, 127.03486],
      location: "익산 왕궁면 논토양 실증 농경지",
      code: "IK",
      nodeCount: 4,
      totalAreaHa: 28.4,
    ...
    },
    {
      ...
      label: "전주",
      route: "전주 조촌 농경지 측정 → 전주 통합 관제",
      center: [35.88568, 127.07218],
      location: "전주 덕진 조촌동 벼 재배 농경지",
      code: "JJ",
      nodeCount: 5,
      totalAreaHa: 31.6,
    ...
    },
    {
      ...
      label: "군산",
      route: "군산 대야 농경지 측정 → 전주 통합 관제",
      center: [35.94628, 126.82492],
      location: "군산 대야면 옥구평야 농경지",
      code: "GS",
      nodeCount: 6,
      totalAreaHa: 36.8,
    ...
    },
    {
      ...
      label: "정읍",
      route: "정읍 태인 농경지 측정 → 전주 통합 관제",
      center: [35.65976, 126.92536],
      location: "정읍 태인면 벼 재배 농경지",
      code: "JU",
      nodeCount: 4,
      totalAreaHa: 24.5,
    ...
    },
    {
      ...
      label: "남원",
      route: "남원 주생 농경지 측정 → 전주 통합 관제",
      center: [35.40612, 127.28694],
      location: "남원 주생면 섬진강 인접 농경지",
      code: "NW",
      nodeCount: 3,
      totalAreaHa: 20.2,
    ...
    },
    {
      ...
      label: "김제",
      route: "김제 만경 농경지 측정 → 전주 통합 관제",
      center: [35.78884, 126.80755],
      location: "김제 만경평야 벼 재배 농경지",
      code: "GJ",
      nodeCount: 5,
      totalAreaHa: 34.1,
    ...
    },
    {
      ...
      label: "완주",
      route: "완주 삼례 농경지 측정 → 전주 통합 관제",
      center: [35.92834, 127.07562],
      location: "완주 삼례읍 만경강 인접 농경지",
      code: "WJ",
      nodeCount: 4,
      totalAreaHa: 27.7,
    ...
    },
    {
      ...
      label: "진안",
      route: "진안 백운 농경지 측정 → 전주 통합 관제",
      center: [35.68842, 127.39576],
      location: "진안 백운면 산간 논토양 농경지",
      code: "JA",
      nodeCount: 3,
      totalAreaHa: 18.9,
    ...
    },
    {
      ...
      label: "고창",
      route: "고창 해리 농경지 측정 → 전주 통합 관제",
      center: [35.45292, 126.54188],
      location: "고창 해리면 벼 재배 농경지",
      code: "GC",
      nodeCount: 4,
      totalAreaHa: 25.8,
    ...
    },
    {
      ...
      label: "부안",
      route: "부안 계화 농경지 측정 → 전주 통합 관제",
      center: [35.77068, 126.68546],
      location: "부안 계화면 새만금 인접 농경지",
      code: "BA",
      nodeCount: 4,
      totalAreaHa: 29.2,
